...
const LoginPage = () => {
  ...
  return (
    <div className="flex w-full h-full px-10 py-10 justify-between place-items-center mt-20">
      <div className="bg-white w-full ml-20 sm:w-full md:w-1/2 lg:w-1/3 px-7 py-7 rounded-xl justify-center align-middle">
        <form
